        ...
        <div className="activitiesGrid">
          ...
          <div className="featuredActivity">
            ...
            <div className="featuredActivityContent">
              <h3 className="featuredActivityTitle">{featuredActivity.title}</h3>
              <p className="featuredActivityDescription">{featuredActivity.description}</p>
              ...
              <a href="#recruitment" className="featuredActivityButton">
